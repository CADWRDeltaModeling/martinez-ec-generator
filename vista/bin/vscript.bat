...
:run1
"%vista_home%/jre6/bin/java" -mx512m  -Djava.library.path=%LPATH% -Dvista.home="%vista_home%" -Dpython.home=%PYHOME% -Dpython.path=%PYPATH% -Dpython.console=org.python.util.InteractiveConsole -classpath %CPATH% org.python.util.jython -i "%vista_home%/lib/__init__.py"
goto end

:run2
"%vista_home%/jre6/bin/java" -mx512m  -Djava.library.path=%LPATH% -Dvista.home="%vista_home%" -Dpython.home=%PYHOME% -Dpython.path=%PYPATH% -Dpython.console=org.python.util.InteractiveConsole -classpath %CPATH% org.python.util.jython -i  %ARGS%
